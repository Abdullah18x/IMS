...
import PmNavbar from "components/Navbars/PmNavbar.js";
...
import routes from "routesPm.js";
...
const switchRoutes = (
  <Switch>
    ...
    <Route path="/pm/profile" component={Profile} />
    <Route path="/pm/orderPage" component={OrderSingle} />
    <Route path="/pm/productPage" component={ProductSingle} />
